...
function DatatableWrapper({ headers, body, isControlled, filterProps, sortProps, paginationProps, paginationOptionsProps, checkboxProps, tableEventsRef, children }) {
    ...
    const onCheckboxChange = (0, react_1.useCallback)(({ prop, nextCheckboxState, checkboxRefs, idProp }) => {
...
function useTableHeaderCheckbox({ headers, initialStates }) {
    const checkboxRefs = (0, react_1.useRef)({});
    (0, react_1.useEffect)(() => {
        if (initialStates) {
            for (const header of headers) {
                const prop = header.prop.toString();
