...
function TableHeader({ classes, controlledProps }) {
    const headings = [];
    const { headers, onSortChange: onSortChangeContext, sortState: sortStateContext, onCheckboxChange: onCheckboxChangeContext, checkboxState: checkboxStateContext, checkboxRefs, filteredDataLength: filteredDataLengthContext, data } = (0, DatatableWrapper_1.useDatatableWrapper)();
