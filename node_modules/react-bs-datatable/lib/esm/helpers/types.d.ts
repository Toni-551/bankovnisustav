import { CSSProperties, MutableRefObject, ReactNode, ThHTMLAttributes } from 'react';
/**
 ...
 */
export declare type ColumnProcessObj<TColumnType, TReturnType = string> = Partial<Record<keyof TColumnType, (column: TColumnType) => TReturnType>>;
/**
