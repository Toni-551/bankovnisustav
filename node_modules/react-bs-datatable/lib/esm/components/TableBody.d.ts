 ...
 * @returns
 */
export declare function TableRow<TTableRowType extends TableRowType>({ rowData, onRowClick: onRowClickProp, classes, controlledProps, rowProps }: TableRowProps<TTableRowType>): JSX.Element;
/**
