...
import { CheckboxOnChange, CheckboxState, ColumnProcessObj, FilterOnChange, PaginationOnChange, RowsPerPageOnChange, SortByPropOnChange, SortType } from '../helpers/types';
...
export declare function DatatableWrapper<TTableRowType = any>({ headers, body, isControlled, filterProps, sortProps, paginationProps, paginationOptionsProps, checkboxProps, tableEventsRef, children }: DatatableWrapperProps<TTableRowType>): JSX.Element;
export {};
